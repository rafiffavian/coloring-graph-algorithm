...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="paralel.php">Paralel</a></li>
  <li role="presentation"><a href="sequential.php">Sequential</a></li>
</ul>
    

<div id="container">
	<h1 style="margin-left:300px;"> Graph coloring Paralel </h1>
...
0 1 1 0 
	...
	<div id="canvasDiv">
		...
		<div class="col-md-6">
			<canvas id="outputCanvas3" width="400px" height="400px"> </canvas> 
		</div>	
		<div class="col-md-6">
